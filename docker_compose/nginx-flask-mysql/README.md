...
When deploying the application, docker compose maps port 80of the proxy service container to port 80of the host as specified in the file.
Make sure port 80on the host is not already being in use.
...
nginx-flask-mysql-backend-1   "flask run"              backend             running             0.0.0.0:8500->8000/tcp
